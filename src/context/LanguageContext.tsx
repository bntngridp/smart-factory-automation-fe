...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    two_factor_setup_btn: 'Setup Authenticator App',
  ...
  id: {
    ...
    two_factor_setup_btn: 'Konfigurasi 2FA (Aplikasi Authenticator)',
  ...
  ar: {
    ...
    two_factor_setup_btn: 'إعداد تطبيق المصادقة',
  ...
  es: {
    ...
    two_factor_setup_btn: 'Configurar App de Autenticación',
