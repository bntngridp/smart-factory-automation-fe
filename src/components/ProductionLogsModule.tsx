        ...
        <form onSubmit={handleSubmitLog} className="space-y-4 text-xs">
          ...
          <div className="flex items-center justify-end pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold text-xs px-6 py-2.5 rounded-xl shadow-sm transition-all disabled:opacity-50 cursor-pointer"
            >
                  ...
                  return (
                    <tr key={log.LogID || index} className="hover:bg-[#1E2D47]/40 transition-colors">
                      ...
                      <td className="p-3.5 text-right">
                        <span className="inline-flex items-center justify-end gap-1.5 text-xs font-medium text-emerald-500">
